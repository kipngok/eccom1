    ...
    <div class="col-sm-6 mb-5">
        ...
        <div class="form-group">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" value="1" name="installation"  onchange="showMe('div1')">
            <label class="form-check-label"><strong></strong>I would like Suki to assist me with the
installation</strong></label>
        </div>
       <div id="div1" style="display:none;">The total cost does not include the installation cost. The
Suki team will reach out with the exact pricing after
submission.</div>
    ...
    <div class="col-sm-6">
        ...
        <div class="alert alert-dark"> <i class="fa fa-exclamation-triangle"></i> <strong>Kindly note:</strong> Local delivery costs are <strong>not included</strong> at checkout.</div>
        </div>
</div>
</form>
</div>
