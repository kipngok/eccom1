...
<div class="container">
	<div class="row mt-5 mb-5 justify-content-center">
		<div class="col-sm-4">
			...
			<p><i class="fa fa-building"></i> Savelberg Centre, along Muringa Road <br> Off Elgeyo Marakwet, Kilimani, Nairobi<br>
		...
		<div class="col-sm-6">
			...
			<form action="/contact" method="POST">
				...
				<button type="submit" class="btn btn-sm btn-warning mt-2">Send Email <i class="fa fa-chevron-right"></i> </button>
			</form>
		</div>
	</div>
</div>
