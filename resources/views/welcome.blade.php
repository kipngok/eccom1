  ...
  <div class="carousel-inner">
    ...
    @foreach($sliders as $slider)
        <div class="carousel-item @if($x<=0) active @endif">
          ...
          @if(isset($slider->url)){{-- <a href="{{$slider->url}}" class="btn btn-md btn-warning animate__animated animate__backInRight" style="max-width: max-content;"></a> --}}@endif
          </div>
        </div>
    <?php $x++;?>
    @endforeach
...
<div class="row mb-5 g-3 owl-carousel owl-theme">
    ...
    <x-product-thumbnail :product="$newProduct" class="item"></x-product-thumbnail>
    @endforeach
</div>
...
<div class="row mb-5 g-3 owl-carousel owl-theme" style="autoPlay: 10000;">
    @foreach($featuredProducts as $featuredProduct)
    <x-product-thumbnail :product="$featuredProduct" class="item"></x-product-thumbnail>
    @endforeach
</div>
...
<div class="row">
    <div class="col-sm-12">
<h4 class="section-heading" class="mt-3"><i class="fa fa-table"></i> BEST SELLERS</h4>
</div>
</div>
<div class="row mb-5 g-3 owl-carousel owl-theme" style="autoPlay: 10000;">
     @foreach($bestSellers as $bestSeller)
    <x-product-thumbnail :product="$bestSeller" class="item"></x-product-thumbnail>
    @endforeach
</div>
<div class="row">
<div class="col-sm-12">
...
<h4 class="mt-3" style="margin-top: 10px; font-weight: 600;">OUR PARTNERS</h4>
</div>
</div>
<div class="row mb-5 g-3 owl-carousel owl-theme">
    ...
    <a href="{{$partner->url}}"style="text-decoration: none;">
     <div class="  h-60"> 
      <img  src="{{ $partner->getMedia('partners')->first()->getUrl() }}" alt="image";  style="width: 210px; height: 100px; object-fit: contain;"  />
