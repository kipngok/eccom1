  ...
  <div class="row mb-5">
    ...
    <div class="form-group">
        ...
        <select name="location" class="form-select @error('location') is-invalid @enderror">
            ...
            @if($banner->location == 'Popup Banner')
            <option selected="selected">Popup Banner</option>
            @else
            <option>Popup Banner</option>
            @endif
            @if($banner->location == 'Mobile Banner Rectangle')
                <option selected="selected">Mobile Banner Rectangle</option>
            @else
                <option>Mobile Banner Rectangle</option>
            @endif

            @if($banner->location == 'Mobile Banner Square')
                <option selected="selected">Mobile Banner Square</option>
            @else
